...
exports.resolversUser = {
    Query: {
        getUser: (_, argument, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    Mutation: {
        registerUser: (_, argument) => __awaiter(void 0, void 0, void 0, function* () {
            const { user } = argument;
        ...
        loginUser: (_, argument) => __awaiter(void 0, void 0, void 0, function* () {
            const { email, password } = argument.user;
            const infoUser = yield user_model_1.default.findOne({
                email: email,
                deleted: false
            });
